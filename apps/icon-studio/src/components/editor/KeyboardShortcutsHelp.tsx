...
import { Keyboard, Info, X, Github } from 'lucide-react';
import { StudioDiamondIcon } from '../common/StudioDiamondIcon';
...
export const KeyboardShortcutsHelp: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (isShortcutsOpen || isInfoOpen) {
      window.addEventListener('keydown', handleKeyDown);
      return () => window.removeEventListener('keydown', handleKeyDown);
    }
  }, [isShortcutsOpen, isInfoOpen]);
        ...
        >
          ...
          >
            ...
            <div className="space-y-2 text-xs">
              <div style={rowStyle}>
                <span style={{ color: 'var(--c-text-secondary)' }}>Paste icon / image anywhere</span>
                <kbd style={kbdStyle}>Ctrl + V / Cmd + V</kbd>
              </div>

              <div style={rowStyle}>
                <span style={{ color: 'var(--c-text-secondary)' }}>Save / Download All Icons</span>
                <kbd style={kbdStyle}>Ctrl + S / Cmd + S</kbd>
              </div>

              <div style={rowStyle}>
                <span style={{ color: 'var(--c-text-secondary)' }}>Close Modals</span>
                <kbd style={kbdStyle}>Esc</kbd>
              </div>

              <div style={rowStyle}>
                <span style={{ color: 'var(--c-text-secondary)' }}>Select files via Dropzone</span>
                <kbd style={kbdStyle}>Click</kbd>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center mb-5">
              ...
              >
                <StudioDiamondIcon className="w-12 h-12 text-white" />
              </div>
            </div>
