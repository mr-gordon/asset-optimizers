      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3" style={{ borderBottom: '1px solid var(--c-border-light)' }}>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3.5 h-8 text-xs font-medium shrink-0 disabled:opacity-40 cursor-pointer"
            style={{
              borderRadius: 'var(--radius-full)',
              background: 'var(--c-surface-alt)',
              color: 'var(--c-text-secondary)',
          ...
          <button
            ...
            disabled={!hasItems || isProcessing}
            title={itemCount > 3 ? 'Save All (ZIP)' : 'Save All'}
            aria-label="Save All"
