...
import { Keyboard, Info, X, Layers } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 right-4 z-20 flex items-center gap-2">
        ...
        >
          <Info className="w-4 h-4" style={{ color: 'var(--c-text-tertiary)' }} />
        </button>
        ...
        >
          <Keyboard className="w-4 h-4" style={{ color: 'var(--c-text-tertiary)' }} />
          ...
          >
            <div className="flex items-center justify-between pb-3" style={{ borderBottom: '1px solid var(--c-border)' }}>
              <h3 className="font-semibold flex items-center gap-2" style={{ fontSize: 'var(--fs-md)', color: 'var(--c-text)' }}>
                <Keyboard className="w-5 h-5" style={{ color: 'var(--c-text-tertiary)' }} />
                Keyboard Shortcuts
              </h3>
              <button
            ...
            <div className="space-y-2 text-xs">
              <div style={rowStyle}>
                <span style={{ color: 'var(--c-text-secondary)' }}>Paste image anywhere</span>
                <kbd style={kbdStyle}>Ctrl + V / Cmd + V</kbd>
              </div>

              <div style={rowStyle}>
                <span style={{ color: 'var(--c-text-secondary)' }}>Save / Download All</span>
                <kbd style={kbdStyle}>Ctrl + S / Cmd + S</kbd>
              </div>

              <div style={rowStyle}>
                <span style={{ color: 'var(--c-text-secondary)' }}>Blink Test Original (in Inspector)</span>
                <kbd style={kbdStyle}>Spacebar</kbd>
              </div>
              ...
              <div style={rowStyle}>
                <span style={{ color: 'var(--c-text-secondary)' }}>Delete active image</span>
      ...
      {isInfoOpen && (
        ...
        >
          ...
          >
            ...
            <p className="text-xs sm:text-sm font-normal mt-3" style={{ color: 'var(--c-text-secondary)' }}>
              Copyright © 2026 Christopher Winker.
            </p>
